...
public class DespitePronounFormАларTests
{
    [Theory]
    ...
    public void DespiteFormPronounForm_Алар_Positive(string verb, string expectedResult)
    {
        var actualResult = DespiteForm.ToDespiteForm(verb, PronounEnum.Алар, VerbFormEnum.Positive);
    ...
    public void DespiteFormPronounForm_Алар_Negative(string verb, string expectedResult)
    {
        var actualResult = DespiteForm.ToDespiteForm(verb, PronounEnum.Алар, VerbFormEnum.Negative);
