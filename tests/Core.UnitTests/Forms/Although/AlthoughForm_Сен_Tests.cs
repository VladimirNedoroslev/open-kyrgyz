...
public class AlthoughPronounFormСенTests
{
    ...
    public void AlthoughFormPronounForm_Сен_Positive(string verb, string expectedResult)
    {
    ...
    public void AlthoughFormPronounForm_Сен_Negative(string verb, string expectedResult)
    {
