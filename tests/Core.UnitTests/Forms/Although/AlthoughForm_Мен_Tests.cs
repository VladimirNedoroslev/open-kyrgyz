...
public class AlthoughPronounFormМенTests
{
    ...
    public void AsSoonAsFormPronounForm_Мен_Positive(string verb, string expectedResult)
    {
    ...
    public void AsSoonAsFormPronounForm_Мен_Negative(string verb, string expectedResult)
    {
