...
public class PresentAndFutureАларTests
{
    ...
    // TODO: verify the correct version for negative and interrogative and amend the algorithm
    // [Theory]
    ...
    // {
    //     // act
    //     var actualResult = PresentAndFutureSimpleTenseConjugator.Conjugate(verb, PronounEnum.Алар, VerbFormEnum.Negative);
    //
    //     // assert
    //     actualResult.Should().Be(expectedResult);
    // }
    ...
    // {
    //     // act
    //     var actualResult = PresentAndFutureSimpleTenseConjugator.Conjugate(verb, PronounEnum.Алар, VerbFormEnum.NegativeAndInterrogative);
    //
    //     // assert
    //     actualResult.Should().Be(expectedResult);
    // }
