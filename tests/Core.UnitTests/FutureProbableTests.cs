...
public class FutureProbableTests
{
    ...
    {
        // act
        var actualResult = FutureProbableConjugator.Conjugate(verb, PronounEnum.Мен);
    ...
    {
        // act
        var actualResult = FutureProbableConjugator.Conjugate(verb, PronounEnum.Сен);
    ...
    {
        // act
        var actualResult = FutureProbableConjugator.Conjugate(verb, PronounEnum.Сиз);
    ...
    {
        // act
        var actualResult = FutureProbableConjugator.Conjugate(verb, PronounEnum.Ал);
    ...
    {
        // act
        var actualResult = FutureProbableConjugator.Conjugate(verb, PronounEnum.Биз);
    ...
    {
        // act
        var actualResult = FutureProbableConjugator.Conjugate(verb, PronounEnum.Силер);
    ...
    {
        // act
        var actualResult = FutureProbableConjugator.Conjugate(verb, PronounEnum.Сиздер);
    ...
    {
        // act
        var actualResult = FutureProbableConjugator.Conjugate(verb, PronounEnum.Алар);
