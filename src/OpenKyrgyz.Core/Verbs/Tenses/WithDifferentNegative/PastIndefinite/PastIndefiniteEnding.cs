...
namespace OpenKyrgyz.Core.Verbs.Tenses.WithDifferentNegative.PastIndefinite;
...
public static class PastIndefiniteEnding
{
    ...
    public static string GetPastIndefiniteEnding(string word)
    {
        var vowelGroup = word.GetVowelGroup();
        var lastLetterType = word.GetLastLetterType();
        return PastMapping[vowelGroup][lastLetterType];
    }

    public static string GetPositiveEnding(string verb, PronounEnum pronoun)
    {
